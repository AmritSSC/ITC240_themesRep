...
#Fills <title> tag  
$config->title = 'Banned Books Pager';
...
<h3 align="center">Banned Books</h3>

<p>Here is a list of banned books!</p>
<?php
...
$showPerPage = 7;  // how many items to show per page

# Create instance of new 'pager' class
//$myPager = new Pager(10,'',$prev,$next,'');
$myPager = new Pager($showPerPage,'',$prev,$next,'');
...
{#records exist - process
	...
	{# process each row
       // echo "<b>" . $row['BannedBookID'] . "</b><br />"; //show book number
       echo '<p align="center">
            <a href="BannedBooks_view.php?id=' . (int)$row['BannedBookID'] . '">' .$row['BannedBookID'] . '. ' . $row['Title'] . ' </p>'; //show book number and title.
    ...
    echo "<p align=center>What! No Books?  There must be a mistake!!</p>";	
}
