<?php
/**
 * upload_execute.php takes ID number & image file sent via upload_form_bannedBooks.php, and 
 ...
 * @see checkFileType()
 * @see upload_form_bannedBooks.php 
...
# retrieve over-rides from upload_form_bannedBooks.php page, if applicable - otherwise safe defaults are provided
...
if(isset($_POST['uploadFolder'])){$uploadFolder = $_POST['uploadFolder'];}else{$uploadFolder = "uploads/bannedBooks";}
 ...
 * an administrator in upload pages (upload_execute.php, upload_form_bannedBooks.php) 
